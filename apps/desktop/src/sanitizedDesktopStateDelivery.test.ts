...
} from "@/sanitizedDesktopStateDelivery";
...
describe("Sanitized Desktop State delivery", () => {
  ...
  test("routes browser fixtures through the same delivery contract", async () => {
  ...
  test("selects only explicit development fixtures", () => {
