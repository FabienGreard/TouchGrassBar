export const downloadFallbackUrl = "https://github.com/FabienGreard/TouchGrassBar/releases/latest";
export const latestReleaseApiUrl =
  "https://api.github.com/repos/FabienGreard/TouchGrassBar/releases/latest";

const releaseRoot = "https://github.com/FabienGreard/TouchGrassBar/releases/download";
...
export function approvedDownloadFromRelease(input: unknown): ApprovedDownload | null {
...
export async function installDownloadResolver(
  ...
  const links = documentObject.querySelectorAll<HTMLAnchorElement>("[data-download-link]");
