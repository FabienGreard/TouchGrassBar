...
function SegmentedControlItem({ className, ...props }: SegmentedControlItemProps) {
  return (
    <TabsTrigger
      className={cn(
        "h-auto min-w-[82px] rounded-[8px] border-transparent bg-transparent px-[13px] py-[7px] text-[8px] font-semibold text-pearl-muted shadow-none hover:bg-pearl-ink/5 hover:text-pearl-ink focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-none data-[state=active]:border-board-tab-active-border data-[state=active]:bg-action data-[state=active]:text-accent-foreground data-[state=active]:shadow-action data-[state=active]:hover:bg-action data-[state=active]:hover:text-accent-foreground data-[state=active]:focus-visible:border-ring",
        className,
      )}
