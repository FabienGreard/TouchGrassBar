    ...
    (
      ...
      createElement(
        HugeiconsIcon,
        {
          ...props,
          className: cn(
            tone === "default" && "text-cream-ink",
            tone === "muted" && "text-cream-muted",
...
const RefreshIcon: TouchGrassIcon = createIcon(
  HugeRefreshIcon,
  "RefreshIcon",
);
const SettingsIcon: TouchGrassIcon = createIcon(
  Settings01Icon,
  "SettingsIcon",
);
const RankingIcon: TouchGrassIcon = createIcon(
  HugeRankingIcon,
  "RankingIcon",
);
