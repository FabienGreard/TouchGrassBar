...
export const settingsStateSchema = z.object({ contractVersion: z.literal(2), section: settingsSectionSchema, launchAtLogin: launchAtLoginStateSchema, profileProvisioning: profileProvisioningStatusSchema, displayName: z.string().nullable().optional(), touchGrassId: z.string().nullable().optional(), providers: z.tuple([providerPresenceSchema, providerPresenceSchema]) }).strict();
