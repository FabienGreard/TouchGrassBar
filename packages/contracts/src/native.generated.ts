...
export const PANEL_PAINT_REQUEST_EVENT = "panel-paint-requested" as const;
...
export const panelPaintRequestSchema = z.object({ sequence: z.number().int().nonnegative() }).strict();
