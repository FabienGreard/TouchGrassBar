...
export const doomerboardViewSchema = z.discriminatedUnion("status", [z.object({ contractVersion: z.literal(1), rows: z.array(doomerboardRowV1Schema).max(100), status: z.literal("ready") }).strict(), z.object({ contractVersion: z.literal(1), status: z.literal("unavailable") }).strict()]);
