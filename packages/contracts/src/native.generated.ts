...
export const sanitizedProfileOutcomeSchema = z.discriminatedUnion("status", [z.object({ status: z.literal("not-authorized") }).strict(), z.object({ status: z.literal("identity-pending") }).strict(), z.object({ displayName: z.string(), touchGrassId: z.string(), status: z.literal("ready") }).strict()]);
