...
const schema = (await new Response(process.stdout).json()) as JsonSchema;
...
export const sanitizedDesktopStateSchema = ${render({ ...schema, properties: { ...schema.properties, contractVersion: { const: 1 } } })};
